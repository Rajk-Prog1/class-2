def division(a: int, b: int) -> tuple:  # No need to worry about this code right now
    ...
    int_div_result = 0  # You need to change this line to calculate integer division

    # Write code to calculate the result of float division
    float_div_result = 0.0  # You need to change this line to calculate float division
